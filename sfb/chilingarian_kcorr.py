...
if __name__ == "__main__":
  ...
  if '-h' in sys.argv:
    print 'calc_kcor filter_name, redshift, colour_name, colour_value'
    sys.exit()
  else:
#    print calc_kcor('g', 0.2, 'g - r', 1.1)
#    print sys.argv[-4],float(sys.argv[-3]),sys.argv[-2].replace('-',' - '),float(sys.argv[-1])
    print 'this methods looks bad, goto omills'
    print sys.argv[-3],calc_kcor(sys.argv[-4],float(sys.argv[-3]),sys.argv[-2].replace('-',' - '),float(sys.argv[-1]))
